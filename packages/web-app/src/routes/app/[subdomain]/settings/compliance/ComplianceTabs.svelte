...
<ul
  class="mt-4 max-w-sm mb-4 mx-auto flex flex-wrap justify-between text-lg font-medium text-center text-black border-b border-gray-200 dark:border-gray-700 dark:text-gray-200"
>
  <li class="me-2">
    <a
